(function (factory) {
    if (typeof module === 'object' && typeof module.exports === 'object') {
        ...
        define(["require", "exports", '@angular/core', '../components/app/app', '../components/app/app-root', '../config/config', '../navigation/deep-linker', '../gestures/gesture-controller', './keyboard', '../components/menu/menu', '../navigation/nav-util', '../components/nav/overlay-portal', '../transitions/page-transition', '../platform/platform', '../platform/query-params', '../components/tabs/tab', '../components/tabs/tabs', '../transitions/transition-controller', '../navigation/url-serializer', '../navigation/view-controller', '../navigation/nav-controller-base', './haptic'], factory);
    }
    ...
    exports.mockNavController = function () {
        ...
        var keyboard = new keyboard_1.Keyboard(config, zone);
    ...
    exports.mockMenu = function () {
        ...
        var gestureCtrl = new gesture_controller_1.GestureController(app);
        return new menu_1.Menu(null, null, null, null, null, null, null, gestureCtrl, app);
    };
