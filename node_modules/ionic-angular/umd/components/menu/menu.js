(function (factory) {
    if (typeof module === 'object' && typeof module.exports === 'object') {
        ...
        define(["require", "exports", '@angular/core', '../app/app', '../backdrop/backdrop', '../../config/config', '../../util/util', '../../util/keyboard', './menu-gestures', './menu-controller', '../../platform/platform', '../../gestures/gesture-controller', '../../util/ui-event-manager', '../content/content'], factory);
    }
    ...
    var Menu = (function () {
        function Menu(_menuCtrl, _elementRef, _config, _platform, _renderer, _keyboard, _zone, _gestureCtrl, _app) {
