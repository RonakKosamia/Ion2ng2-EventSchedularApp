    ...
    var InputBase = (function (_super) {
        ...
        InputBase.prototype.initFocus = function () {
            ...
            if (scrollView) {
                ...
                var scrollData = getScrollData(ele.offsetTop, ele.offsetHeight, scrollView.getContentDimensions(), this._keyboardHeight, this._platform.height());
                ...
                scrollView.scrollTo(0, scrollData.scrollTo, scrollDuration, function () {
                    (void 0);
