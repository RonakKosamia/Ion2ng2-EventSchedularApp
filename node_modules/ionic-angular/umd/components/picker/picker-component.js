(function (factory) {
    if (typeof module === 'object' && typeof module.exports === 'object') {
        ...
        define(["require", "exports", '@angular/core', '@angular/platform-browser', '../../util/dom', '../../util/util', '../../config/config', '../../util/key', '../../navigation/nav-params', '../../util/haptic', '../../util/ui-event-manager', '../../navigation/view-controller', '../../util/debouncer', '../../gestures/gesture-controller'], factory);
    }
    ...
    var PickerColumnCmp = (function () {
        function PickerColumnCmp(config, elementRef, _sanitizer, _zone, _haptic) {
            ...
            this.pos = [];
            this.startY = null;
            this.debouncer = new debouncer_1.NativeRafDebouncer();
        ...
        PickerColumnCmp.prototype.decelerate = function () {
            ...
            if (isNaN(this.y) || !this.optHeight) {
                ...
                if (notLockedIn) {
                    this.rafId = dom_1.nativeRaf(this.decelerateFunc);
                }
            }
        ...
        PickerColumnCmp.prototype.update = function (y, duration, saveY, emitChange) {
            ...
            for (i = 0; i < length; i++) {
                ...
                if (duration !== opt._dur) {
                    opt._dur = duration;
                    button.style[dom_1.CSS.transitionDuration] = durationStr;
                }
                if (transform !== opt._trans) {
                    opt._trans = transform;
                    button.style[dom_1.CSS.transform] = transform;
                }
    ...
    var PickerCmp = (function () {
        function PickerCmp(_viewCtrl, _elementRef, _config, gestureCtrl, params, renderer) {
