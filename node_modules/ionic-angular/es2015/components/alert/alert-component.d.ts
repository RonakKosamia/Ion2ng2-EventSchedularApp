...
export declare class AlertCmp {
    ...
    constructor(_viewCtrl: ViewController, _elementRef: ElementRef, _config: Config, gestureCtrl: GestureController, params: NavParams, _renderer: Renderer, _platform: Platform);
    ionViewDidLoad(): void;
