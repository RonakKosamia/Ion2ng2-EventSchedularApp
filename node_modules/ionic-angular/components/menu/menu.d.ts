...
export declare class Menu {
    ...
    constructor(_menuCtrl: MenuController, _elementRef: ElementRef, _config: Config, _platform: Platform, _renderer: Renderer, _keyboard: Keyboard, _zone: NgZone, _gestureCtrl: GestureController, _app: App);
    ngOnInit(): void;
