...
export var nativeRaf = originalRaf !== undefined ? originalRaf['bind'](window) : window.requestAnimationFrame.bind(window);
export var raf = window.requestAnimationFrame.bind(window);
export var cancelRaf = window.cancelAnimationFrame.bind(window);
export var nativeTimeout = window[window['Zone']['__symbol__']('setTimeout')]['bind'](window);
export var clearNativeTimeout = window[window['Zone']['__symbol__']('clearTimeout')]['bind'](window);
